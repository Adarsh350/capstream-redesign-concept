...
## Corpus Check
- 16 files · ~12,931 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 86 nodes · 82 edges · 10 communities (7 shown, 3 thin omitted)
...
Cohesion: 0.14
Nodes (13): engines, node, name, overrides, postcss, sharp, private, scripts (+5 more)
...
- **Why does `compilerOptions` connect `Community 1` to `Community 4`, `Community 6`?**
